...
events_columns_to_keep = ['ARC_ID_HASH', 'ARC_LENGTH_DS', 'ROAD_PRIORITY_DS', 'ROAD_ROUNDABOUT_DS', 'ROAD_LANES_DS', 'LANES_FORWARD_DS', 'TUNNEL_DS', 'BRIDGE_DS', 'SPEED_LIMIT_DS', 'CURVE_MAX_ANGLE_DS', 'events_count']
...
aadt_events_crashes_train_pd = aadt_events_crashes_train_pd[['ARC_LENGTH_DS', 'ROAD_PRIORITY_DS', 'ROAD_ROUNDABOUT_DS', 'ROAD_LANES_DS', 'LANES_FORWARD_DS', 'BRIDGE_DS', 'SPEED_LIMIT_DS', 'CURVE_MAX_ANGLE_DS', 'events_count','crashes_count', 'AADT_2022', 'CloseToPOI']]
...
#                 'SPEED_LIMIT_DS','events_count','crashes_count', 'CloseToPOI' ]
feature_cols = ['ROAD_PRIORITY_DS','ROAD_ROUNDABOUT_DS',
                'TUNNEL_DS','BRIDGE_DS', 'CURVE_MAX_ANGLE_DS',
                'SPEED_LIMIT_DS', 'CloseToPOI' ]
# TRI_RAW_START
...
test_df = test_predictions.select( ['ARC_ID_HASH','ARC_LENGTH_DS', 'ROAD_PRIORITY_DS',
                                    ...
                                    'events_count','crashes_count', 'AADT_2022','CloseToPOI',
                                    'prediction'])
