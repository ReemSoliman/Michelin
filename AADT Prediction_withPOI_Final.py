...
rf = RandomForestRegressor(featuresCol="features",labelCol="AADT_2022" , numTrees=10) #labelCol="crashes_aadt"
...
# Evaluate the model
evaluator = RegressionEvaluator(labelCol="AADT_2022", predictionCol="prediction", metricName="rmse")
...
# Evaluate the Model
evaluator = RegressionEvaluator(labelCol="AADT_2022", predictionCol="prediction")
...
test_df = test_predictions.select( ['ARC_ID_HASH','ARC_LENGTH_DS', 'ROAD_PRIORITY_DS',
                                    ...
                                    'events_count','crashes_count','prediction','CloseToPOI',   #'AADT_2022'
                                    ])
